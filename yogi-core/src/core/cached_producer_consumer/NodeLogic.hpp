#ifndef CHIRP_CORE_CACHED_PRODUCER_CONSUMER_NODELOGIC_HPP
#define CHIRP_CORE_CACHED_PRODUCER_CONSUMER_NODELOGIC_HPP
...
#endif // CHIRP_CORE_CACHED_PRODUCER_CONSUMER_NODELOGIC_HPP
