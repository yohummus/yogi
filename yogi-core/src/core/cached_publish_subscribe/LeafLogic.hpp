#ifndef CHIRP_CORE_CACHED_PUBLISH_SUBSCRIBE_LEAFLOGIC_HPP
#define CHIRP_CORE_CACHED_PUBLISH_SUBSCRIBE_LEAFLOGIC_HPP
...
#endif // CHIRP_CORE_CACHED_PUBLISH_SUBSCRIBE_LEAFLOGIC_HPP
