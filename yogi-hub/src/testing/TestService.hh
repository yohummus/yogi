...
private:
    ...
    bool handle_command(const QString& command);
    bool handle_reset_command(const QStringList& args);
    bool handle_create_yogi_tcp_factories_command(const QStringList& args);
    bool handle_destroy_yogi_tcp_client_command(const QStringList& args);
    bool handle_create_test_terminals_command(const QStringList& args);
    bool handle_destroy_test_terminals_command(const QStringList& args);
    bool handle_ps_publish_command(const QStringList& args);
    bool handle_ps_check_published_command(const QStringList& args);
    bool handle_sg_scatter_command(const QStringList& args);
    bool handle_sg_check_gathered_respond_command(const QStringList& args);
    bool handle_sg_check_gathered_ignore_command(const QStringList& args);
    bool handle_cps_publish_command(const QStringList& args);
    bool handle_cps_check_published_command(const QStringList& args);
    bool handle_producer_publish_command(const QStringList& args);
    bool handle_consumer_check_published_command(const QStringList& args);
    bool handle_cached_producer_publish_command(const QStringList& args);
    bool handle_cached_consumer_check_published_command(const QStringList& args);
    bool handle_master_publish_command(const QStringList& args);
    bool handle_master_check_published_command(const QStringList& args);
    bool handle_slave_publish_command(const QStringList& args);
    bool handle_slave_check_published_command(const QStringList& args);
    bool handle_cached_master_publish_command(const QStringList& args);
    bool handle_cached_master_check_published_command(const QStringList& args);
    bool handle_cached_slave_publish_command(const QStringList& args);
    bool handle_cached_slave_check_published_command(const QStringList& args);
    bool handle_sc_request_command(const QStringList& args);
    bool handle_sc_check_responded_command(const QStringList& args);
    bool handle_sc_check_ignored_command(const QStringList& args);
    bool handle_create_tree_test_terminals_command(const QStringList& args);
    bool handle_destroy_tree_test_terminals_command(const QStringList& args);
    bool handle_create_signature_test_terminals_command(const QStringList& args);
    bool handle_destroy_signature_test_terminals_command(const QStringList& args);
	bool handle_create_producer_terminal_command(const QStringList& args);
	bool handle_destroy_producer_terminal_command(const QStringList& args);
    bool handle_create_consumer_terminal_command(const QStringList& args);
    bool handle_destroy_consumer_terminal_command(const QStringList& args);
};

} // namespace testing

#endif // TESTING_TESTSERVICE_HPP
