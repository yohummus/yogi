...
#ifndef PROTOBUF_yogi_5f0000000a_2eproto__INCLUDED
#define PROTOBUF_yogi_5f0000000a_2eproto__INCLUDED
...
class ScatterMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000000a_ns.ScatterMessage) */ {
 public:
  ScatterMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000000a_ns.ScatterMessage)
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_yogi_5f0000000a_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_yogi_5f0000000a_2eproto();
  #endif
  friend void protobuf_AssignDesc_yogi_5f0000000a_2eproto();
  friend void protobuf_ShutdownFile_yogi_5f0000000a_2eproto();
...
class GatherMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000000a_ns.GatherMessage) */ {
 public:
  GatherMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000000a_ns.GatherMessage)
 private:
...
class PublishMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000000a_ns.PublishMessage) */ {
 public:
  PublishMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000000a_ns.PublishMessage)
 private:
...
class MasterMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000000a_ns.MasterMessage) */ {
 public:
  MasterMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000000a_ns.MasterMessage)
 private:
...
class SlaveMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000000a_ns.SlaveMessage) */ {
 public:
  SlaveMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000000a_ns.SlaveMessage)
 private:
...
struct yogi_0000000a
{
    typedef yogi_0000000a_ns::PublishMessage PublishMessage;
    typedef yogi_0000000a_ns::ScatterMessage ScatterMessage;
    typedef yogi_0000000a_ns::GatherMessage  GatherMessage;
    typedef yogi_0000000a_ns::MasterMessage  MasterMessage;
    typedef yogi_0000000a_ns::SlaveMessage   SlaveMessage;
...
#endif  // PROTOBUF_yogi_5f0000000a_2eproto__INCLUDED
