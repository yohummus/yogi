...
// source: chirp_00000c07.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "chirp_00000c07.h"
...
void protobuf_AssignDesc_chirp_5f00000c07_2eproto() {
  protobuf_AddDesc_chirp_5f00000c07_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "chirp_00000c07.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_chirp_5f00000c07_2eproto);
}
...
void protobuf_ShutdownFile_chirp_5f00000c07_2eproto() {
...
void protobuf_AddDesc_chirp_5f00000c07_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024chirp_00000c07.proto\022\016chirp_00000c07\"\020"
    "\n\016ScatterMessage\"5\n\rGatherMessage\022\021\n\ttim"
    "estamp\030\001 \001(\004\022\021\n\005value\030\002 \003(\021B\002\020\001\"6\n\016Publi"
    "shMessage\022\021\n\ttimestamp\030\001 \001(\004\022\021\n\005value\030\002 "
    "\003(\021B\002\020\001b\006proto3", 175);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "chirp_00000c07.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_chirp_5f00000c07_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_chirp_5f00000c07_2eproto {
  StaticDescriptorInitializer_chirp_5f00000c07_2eproto() {
    protobuf_AddDesc_chirp_5f00000c07_2eproto();
  }
} static_descriptor_initializer_chirp_5f00000c07_2eproto_;
...
ScatterMessage::ScatterMessage()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:chirp_00000c07_ns.ScatterMessage)
}
...
ScatterMessage::ScatterMessage(const ScatterMessage& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:chirp_00000c07_ns.ScatterMessage)
}
...
ScatterMessage::~ScatterMessage() {
  // @@protoc_insertion_point(destructor:chirp_00000c07_ns.ScatterMessage)
  SharedDtor();
}
...
const ScatterMessage& ScatterMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_chirp_5f00000c07_2eproto();
...
// @@protoc_insertion_point(message_clear_start:chirp_00000c07_ns.ScatterMessage)
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:chirp_00000c07_ns.ScatterMessage)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:chirp_00000c07_ns.ScatterMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:chirp_00000c07_ns.ScatterMessage)
  return false;
#undef DO_
}
...
void ScatterMessage::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:chirp_00000c07_ns.ScatterMessage)
  // @@protoc_insertion_point(serialize_end:chirp_00000c07_ns.ScatterMessage)
}

::google::protobuf::uint8* ScatterMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:chirp_00000c07_ns.ScatterMessage)
  // @@protoc_insertion_point(serialize_to_array_end:chirp_00000c07_ns.ScatterMessage)
  return target;
}

int ScatterMessage::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:chirp_00000c07_ns.ScatterMessage)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:chirp_00000c07_ns.ScatterMessage)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const ScatterMessage* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const ScatterMessage>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:chirp_00000c07_ns.ScatterMessage)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:chirp_00000c07_ns.ScatterMessage)
    MergeFrom(*source);
  }
}

void ScatterMessage::MergeFrom(const ScatterMessage& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:chirp_00000c07_ns.ScatterMessage)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
}

void ScatterMessage::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:chirp_00000c07_ns.ScatterMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:chirp_00000c07_ns.ScatterMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
GatherMessage::GatherMessage()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:chirp_00000c07_ns.GatherMessage)
}
...
GatherMessage::GatherMessage(const GatherMessage& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:chirp_00000c07_ns.GatherMessage)
}
...
GatherMessage::~GatherMessage() {
  // @@protoc_insertion_point(destructor:chirp_00000c07_ns.GatherMessage)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:chirp_00000c07_ns.GatherMessage)
  timestamp_ = GOOGLE_ULONGLONG(0);
  value_.Clear();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:chirp_00000c07_ns.GatherMessage)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:chirp_00000c07_ns.GatherMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:chirp_00000c07_ns.GatherMessage)
  return false;
#undef DO_
}
...
void GatherMessage::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:chirp_00000c07_ns.GatherMessage)
  // optional uint64 timestamp = 1;
  if (this->timestamp() != 0) {
  ...
  // @@protoc_insertion_point(serialize_end:chirp_00000c07_ns.GatherMessage)
}

::google::protobuf::uint8* GatherMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:chirp_00000c07_ns.GatherMessage)
  // optional uint64 timestamp = 1;
  if (this->timestamp() != 0) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:chirp_00000c07_ns.GatherMessage)
  return target;
}

int GatherMessage::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:chirp_00000c07_ns.GatherMessage)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:chirp_00000c07_ns.GatherMessage)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const GatherMessage* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const GatherMessage>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:chirp_00000c07_ns.GatherMessage)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:chirp_00000c07_ns.GatherMessage)
    MergeFrom(*source);
  }
}

void GatherMessage::MergeFrom(const GatherMessage& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:chirp_00000c07_ns.GatherMessage)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
...
// @@protoc_insertion_point(generalized_copy_from_start:chirp_00000c07_ns.GatherMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:chirp_00000c07_ns.GatherMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void GatherMessage::clear_timestamp() {
 ...
 ::google::protobuf::uint64 GatherMessage::timestamp() const {
  // @@protoc_insertion_point(field_get:chirp_00000c07_ns.GatherMessage.timestamp)
  return timestamp_;
}
 void GatherMessage::set_timestamp(::google::protobuf::uint64 value) {
  
  timestamp_ = value;
  // @@protoc_insertion_point(field_set:chirp_00000c07_ns.GatherMessage.timestamp)
}
...
void GatherMessage::clear_value() {
 ...
 ::google::protobuf::int32 GatherMessage::value(int index) const {
  // @@protoc_insertion_point(field_get:chirp_00000c07_ns.GatherMessage.value)
  return value_.Get(index);
}
 void GatherMessage::set_value(int index, ::google::protobuf::int32 value) {
  value_.Set(index, value);
  // @@protoc_insertion_point(field_set:chirp_00000c07_ns.GatherMessage.value)
}
 void GatherMessage::add_value(::google::protobuf::int32 value) {
  value_.Add(value);
  // @@protoc_insertion_point(field_add:chirp_00000c07_ns.GatherMessage.value)
}
 const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
GatherMessage::value() const {
  // @@protoc_insertion_point(field_list:chirp_00000c07_ns.GatherMessage.value)
  return value_;
}
 ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
GatherMessage::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:chirp_00000c07_ns.GatherMessage.value)
  return &value_;
}
...
PublishMessage::PublishMessage()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:chirp_00000c07_ns.PublishMessage)
}
...
PublishMessage::PublishMessage(const PublishMessage& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:chirp_00000c07_ns.PublishMessage)
}
...
PublishMessage::~PublishMessage() {
  // @@protoc_insertion_point(destructor:chirp_00000c07_ns.PublishMessage)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:chirp_00000c07_ns.PublishMessage)
  timestamp_ = GOOGLE_ULONGLONG(0);
  value_.Clear();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:chirp_00000c07_ns.PublishMessage)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:chirp_00000c07_ns.PublishMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:chirp_00000c07_ns.PublishMessage)
  return false;
#undef DO_
}
...
void PublishMessage::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:chirp_00000c07_ns.PublishMessage)
  // optional uint64 timestamp = 1;
  if (this->timestamp() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(1, this->timestamp(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:chirp_00000c07_ns.PublishMessage)
}

::google::protobuf::uint8* PublishMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:chirp_00000c07_ns.PublishMessage)
  // optional uint64 timestamp = 1;
  if (this->timestamp() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(1, this->timestamp(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:chirp_00000c07_ns.PublishMessage)
  return target;
}

int PublishMessage::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:chirp_00000c07_ns.PublishMessage)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:chirp_00000c07_ns.PublishMessage)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const PublishMessage* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const PublishMessage>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:chirp_00000c07_ns.PublishMessage)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:chirp_00000c07_ns.PublishMessage)
    MergeFrom(*source);
  }
}

void PublishMessage::MergeFrom(const PublishMessage& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:chirp_00000c07_ns.PublishMessage)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  value_.MergeFrom(from.value_);
  if (from.timestamp() != 0) {
    set_timestamp(from.timestamp());
...
// @@protoc_insertion_point(generalized_copy_from_start:chirp_00000c07_ns.PublishMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:chirp_00000c07_ns.PublishMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void PublishMessage::clear_timestamp() {
 ...
 ::google::protobuf::uint64 PublishMessage::timestamp() const {
  // @@protoc_insertion_point(field_get:chirp_00000c07_ns.PublishMessage.timestamp)
  return timestamp_;
}
 void PublishMessage::set_timestamp(::google::protobuf::uint64 value) {
  
  timestamp_ = value;
  // @@protoc_insertion_point(field_set:chirp_00000c07_ns.PublishMessage.timestamp)
}
...
void PublishMessage::clear_value() {
 ...
 ::google::protobuf::int32 PublishMessage::value(int index) const {
  // @@protoc_insertion_point(field_get:chirp_00000c07_ns.PublishMessage.value)
  return value_.Get(index);
}
 void PublishMessage::set_value(int index, ::google::protobuf::int32 value) {
  value_.Set(index, value);
  // @@protoc_insertion_point(field_set:chirp_00000c07_ns.PublishMessage.value)
}
 void PublishMessage::add_value(::google::protobuf::int32 value) {
  value_.Add(value);
  // @@protoc_insertion_point(field_add:chirp_00000c07_ns.PublishMessage.value)
}
 const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
PublishMessage::value() const {
  // @@protoc_insertion_point(field_list:chirp_00000c07_ns.PublishMessage.value)
  return value_;
}
 ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
PublishMessage::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:chirp_00000c07_ns.PublishMessage.value)
  return &value_;
}
