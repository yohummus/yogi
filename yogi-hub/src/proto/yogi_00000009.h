...
#ifndef PROTOBUF_yogi_5f00000009_2eproto__INCLUDED
#define PROTOBUF_yogi_5f00000009_2eproto__INCLUDED
...
class ScatterMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_00000009_ns.ScatterMessage) */ {
 public:
  ScatterMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_00000009_ns.ScatterMessage)
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_yogi_5f00000009_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_yogi_5f00000009_2eproto();
  #endif
  friend void protobuf_AssignDesc_yogi_5f00000009_2eproto();
  friend void protobuf_ShutdownFile_yogi_5f00000009_2eproto();
...
class GatherMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_00000009_ns.GatherMessage) */ {
 public:
  GatherMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_00000009_ns.GatherMessage)
 private:
...
class PublishMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_00000009_ns.PublishMessage) */ {
 public:
  PublishMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_00000009_ns.PublishMessage)
 private:
...
class MasterMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_00000009_ns.MasterMessage) */ {
 public:
  MasterMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_00000009_ns.MasterMessage)
 private:
...
class SlaveMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_00000009_ns.SlaveMessage) */ {
 public:
  SlaveMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_00000009_ns.SlaveMessage)
 private:
...
inline ::google::protobuf::int64 GatherMessage::value() const {
  // @@protoc_insertion_point(field_get:yogi_00000009_ns.GatherMessage.value)
  return value_;
}
inline void GatherMessage::set_value(::google::protobuf::int64 value) {
...
inline ::google::protobuf::int64 PublishMessage::value() const {
  // @@protoc_insertion_point(field_get:yogi_00000009_ns.PublishMessage.value)
  return value_;
}
inline void PublishMessage::set_value(::google::protobuf::int64 value) {
...
inline ::google::protobuf::int64 SlaveMessage::value() const {
  // @@protoc_insertion_point(field_get:yogi_00000009_ns.SlaveMessage.value)
  return value_;
}
inline void SlaveMessage::set_value(::google::protobuf::int64 value) {
...
struct yogi_00000009
{
    typedef yogi_00000009_ns::PublishMessage PublishMessage;
    typedef yogi_00000009_ns::ScatterMessage ScatterMessage;
    typedef yogi_00000009_ns::GatherMessage  GatherMessage;
    typedef yogi_00000009_ns::MasterMessage  MasterMessage;
    typedef yogi_00000009_ns::SlaveMessage   SlaveMessage;
...
#endif  // PROTOBUF_yogi_5f00000009_2eproto__INCLUDED
