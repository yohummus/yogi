...
#ifndef PROTOBUF_yogi_5f0000c00c_2eproto__INCLUDED
#define PROTOBUF_yogi_5f0000c00c_2eproto__INCLUDED
...
class ScatterMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000c00c_ns.ScatterMessage) */ {
 public:
  ScatterMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000c00c_ns.ScatterMessage)
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_yogi_5f0000c00c_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_yogi_5f0000c00c_2eproto();
  #endif
  friend void protobuf_AssignDesc_yogi_5f0000c00c_2eproto();
  friend void protobuf_ShutdownFile_yogi_5f0000c00c_2eproto();
...
class GatherMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000c00c_ns.GatherMessage) */ {
 public:
  GatherMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000c00c_ns.GatherMessage)
 private:
...
class PublishMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000c00c_ns.PublishMessage) */ {
 public:
  PublishMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000c00c_ns.PublishMessage)
 private:
...
class MasterMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000c00c_ns.MasterMessage) */ {
 public:
  MasterMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000c00c_ns.MasterMessage)
 private:
...
class SlaveMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:yogi_0000c00c_ns.SlaveMessage) */ {
 public:
  SlaveMessage();
  ...
  // @@protoc_insertion_point(class_scope:yogi_0000c00c_ns.SlaveMessage)
 private:
...
inline double ScatterMessage::value() const {
  // @@protoc_insertion_point(field_get:yogi_0000c00c_ns.ScatterMessage.value)
  return value_;
}
inline void ScatterMessage::set_value(double value) {
...
inline double MasterMessage::value() const {
  // @@protoc_insertion_point(field_get:yogi_0000c00c_ns.MasterMessage.value)
  return value_;
}
inline void MasterMessage::set_value(double value) {
...
struct yogi_0000c00c
{
    typedef yogi_0000c00c_ns::PublishMessage PublishMessage;
    typedef yogi_0000c00c_ns::ScatterMessage ScatterMessage;
    typedef yogi_0000c00c_ns::GatherMessage  GatherMessage;
    typedef yogi_0000c00c_ns::MasterMessage  MasterMessage;
    typedef yogi_0000c00c_ns::SlaveMessage   SlaveMessage;

    enum {
        SIGNATURE = 0x0000c00c
    };
};

// @@protoc_insertion_point(global_scope)

#endif  // PROTOBUF_yogi_5f0000c00c_2eproto__INCLUDED
